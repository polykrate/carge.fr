              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50/50 border border-blue-100 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-semibold text-gray-900">{t('quickSign.step1Title')}</h3>
                  </div>
                  <p className="text-sm text-gray-600">{t('quickSign.step1Desc')}</p>
                </div>
                <div className="bg-blue-50/50 border border-blue-100 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-8 h-8 bg-[#003399] rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <h3 className="font-semibold text-gray-900">{t('quickSign.step2Title')}</h3>
                  </div>
                  <p className="text-sm text-gray-600">{t('quickSign.step2Desc')}</p>
                </div>
                <div className="bg-blue-50/50 border border-blue-100 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-8 h-8 bg-[#003399] rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <h3 className="font-semibold text-gray-900">{t('quickSign.step3Title')}</h3>
                  </div>
                  <p className="text-sm text-gray-600">{t('quickSign.step3Desc')}</p>
                </div>
              </div>
            </div>
          )}
